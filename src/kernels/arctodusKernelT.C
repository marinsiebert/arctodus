#include "arctodusKernelT.h"

registerMooseObject("arctodusApp", arctodusKernelT);

InputParameters
arctodusKernelT::validParams()
{
...
arctodusKernelT::arctodusKernelT(const InputParameters & parameters)
...
/******************************************************************************/
Real
arctodusKernelT::computeQpResidual()
{
...
/******************************************************************************/
Real
arctodusKernelT::computeQpJacobian()
{
...
/******************************************************************************/
Real
arctodusKernelT::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real jac = 0.0;
